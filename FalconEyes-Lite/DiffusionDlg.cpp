...
void CDiffusionDlg::DoDataExchange(CDataExchange* pDX)
{
	...
	DDX_Text(pDX, IDC_EDIT_DIFFUSION_LAMBDA, m_fLambda);
	DDV_MinMaxFloat(pDX, m_fLambda, 0.0, 0.25);
	DDX_Text(pDX, IDC_EDIT_DIFFUSION_K, m_fK);
	DDX_Text(pDX, IDC_EDIT_DIFFUSION_ITER, m_nIteration);
	DDV_MinMaxFloat(pDX, m_nIteration, 0, 100);
}
