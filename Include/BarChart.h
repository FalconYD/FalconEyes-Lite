...
protected:
	...
	class CChartBar : public CChartGCalc
	{
		...
		void DrawBarsHistogram(CDC* pDC, CRect& rcBound);
	...
	public:
		...
		void AddBar(int udValue,CString szLabel, COLORREF color);
...
public:
	...
	void AddBar(int udValue, CString szLabel, COLORREF color, BOOL bRepaint = FALSE);
